    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { OursPrivacy::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { OursPrivacy::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            OursPrivacy::FilePart.new(value)
          in OursPrivacy::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in OursPrivacy::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [OursPrivacy::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: OursPrivacy::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in OursPrivacy::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in OursPrivacy::Internal::Type::Converter
              ...
              OursPrivacy::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(OursPrivacy::Internal::Type::Converter, T::Class[T.anything]) }
        end
