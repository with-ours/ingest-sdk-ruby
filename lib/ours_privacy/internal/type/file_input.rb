...
module OursPrivacy
  module Internal
    module Type
      ...
      # `OursPrivacy::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | OursPrivacy::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= OursPrivacy::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              OursPrivacy::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? OursPrivacy::FilePart.new(value, filename: "upload") : value
            in OursPrivacy::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
