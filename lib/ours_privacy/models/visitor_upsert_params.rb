...
module OursPrivacy
  module Models
    ...
    class VisitorUpsertParams < OursPrivacy::Internal::Type::BaseModel
      extend OursPrivacy::Internal::Type::RequestParameters::Converter
      include OursPrivacy::Internal::Type::RequestParameters
      ...
      #   them.
      #
      #   @return [OursPrivacy::Models::VisitorUpsertParams::UserProperties]
      required :user_properties,
               -> { OursPrivacy::VisitorUpsertParams::UserProperties },
      ...
      #   destinations
      #
      #   @return [OursPrivacy::Models::VisitorUpsertParams::DefaultProperties, nil]
      optional :default_properties,
               -> { OursPrivacy::VisitorUpsertParams::DefaultProperties },
      ...
      #   {OursPrivacy::Models::VisitorUpsertParams} for more details.
      #
      #   @param token [String] The token for your Ours Privacy Source. You can find this in the Ours dashboard.
      #
      #   @param user_properties [OursPrivacy::Models::VisitorUpsertParams::UserProperties] User properties to associate with this user. The existing user properties will b
      #
      #   @param default_properties [OursPrivacy::Models::VisitorUpsertParams::DefaultProperties, nil] These properties are used throughout the Ours app to pass known values onto dest
      #
      ...
      #
      #   @param request_options [OursPrivacy::RequestOptions, Hash{Symbol=>Object}]

      class UserProperties < OursPrivacy::Internal::Type::BaseModel
        # @!attribute ad_id
        #
        #   @return [String, nil]
        ...
        optional :consent,
                 OursPrivacy::Internal::Type::HashOf[OursPrivacy::Internal::Type::Unknown, nil?: true],
                 nil?: true
        ...
        #
        #   @return [Object, nil]
        optional :is_bot, OursPrivacy::Internal::Type::Unknown
        ...
        #
        #   @return [Object, nil]
        optional :phone_number, OursPrivacy::Internal::Type::Unknown
        ...
        #
        #   @return [Object, nil]
        optional :zip, OursPrivacy::Internal::Type::Unknown
      ...
      class DefaultProperties < OursPrivacy::Internal::Type::BaseModel
        ...
        #
        #   @return [Boolean, nil]
        optional :fv, OursPrivacy::Internal::Type::Boolean, nil?: true
        ...
        #
        #   @return [Boolean, nil]
        optional :iframe, OursPrivacy::Internal::Type::Boolean, nil?: true
        ...
        #
        #   @return [Boolean, nil]
        optional :new_s, OursPrivacy::Internal::Type::Boolean, nil?: true
        ...
        #
        #   @return [Boolean, nil]
        optional :webview, OursPrivacy::Internal::Type::Boolean, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {OursPrivacy::Models::VisitorUpsertParams::DefaultProperties} for more details.
        #
        #   These properties are used throughout the Ours app to pass known values onto
        #   destinations
        #
