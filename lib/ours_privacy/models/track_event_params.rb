...
module OursPrivacy
  module Models
    ...
    class TrackEventParams < OursPrivacy::Internal::Type::BaseModel
      ...
      #   destinations
      #
      #   @return [OursPrivacy::Models::TrackEventParams::DefaultProperties, nil]
      optional :default_properties,
               -> { OursPrivacy::TrackEventParams::DefaultProperties },
      ...
      #
      #   @return [OursPrivacy::Models::TrackEventParams::UserProperties, nil]
      optional :user_properties,
               -> { OursPrivacy::TrackEventParams::UserProperties },
      ...
      #   {OursPrivacy::Models::TrackEventParams} for more details.
      #
      ...
      #
      #   @param default_properties [OursPrivacy::Models::TrackEventParams::DefaultProperties, nil] These properties are used throughout the Ours app to pass known values onto dest
      #
      ...
      #
      #   @param user_properties [OursPrivacy::Models::TrackEventParams::UserProperties, nil] Properties to set on the visitor. (optional) You can also update these propertie
      #
      ...
      class DefaultProperties < OursPrivacy::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {OursPrivacy::Models::TrackEventParams::DefaultProperties} for more details.
        #
        #   These properties are used throughout the Ours app to pass known values onto
        #   destinations
        #
