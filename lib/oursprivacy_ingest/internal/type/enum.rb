    ...
    module Type
      ...
      module Enum
        ...
        def ==(other)
          ...
          OursprivacyIngest::Internal::Type::Enum === other && other.values.to_set == values.to_set
        ...
        def inspect(depth: 0)
          ...
          members = values.map { OursprivacyIngest::Internal::Type::Converter.inspect(_1, depth: depth.succ) }
