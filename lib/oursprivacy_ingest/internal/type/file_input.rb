...
module OursprivacyIngest
  module Internal
    module Type
      ...
      # `OursprivacyIngest::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | OursprivacyIngest::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= OursprivacyIngest::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              OursprivacyIngest::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? OursprivacyIngest::FilePart.new(value, filename: "upload") : value
            in OursprivacyIngest::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
