  ...
  module Internal
    module Type
      ...
      module Union
        ...
        # @api private
        #
        # @param key [Symbol, Hash{Symbol=>Object}, Proc, OursprivacyIngest::Internal::Type::Converter, Class]
        #
        # @param spec [Hash{Symbol=>Object}, Proc, OursprivacyIngest::Internal::Type::Converter, Class] .
        #
        ...
        private def variant(key, spec = nil)
          meta = OursprivacyIngest::Internal::Type::Converter.meta_info(nil, spec)
          variant_info =
            case key
            in Symbol
              [key, OursprivacyIngest::Internal::Type::Converter.type_info(spec), meta]
            in Proc | OursprivacyIngest::Internal::Type::Converter | Class | Hash
              [nil, OursprivacyIngest::Internal::Type::Converter.type_info(key), meta]
            end
        ...
        # @param value [Object]
        #
        # @return [OursprivacyIngest::Internal::Type::Converter, Class, nil]
        private def resolve_variant(value)
          case [@discriminator, value]
          in [_, OursprivacyIngest::Internal::Type::BaseModel]
            value.class
          in [Symbol, Hash]
            key = value.fetch(@discriminator) do
              value.fetch(@discriminator.to_s, OursprivacyIngest::Internal::OMIT)
            end

            return nil if key == OursprivacyIngest::Internal::OMIT
        ...
        # @return [Boolean]
        def ==(other)
          OursprivacyIngest::Internal::Type::Union === other && other.derefed_variants == derefed_variants
        end
        ...
        def coerce(value, state:)
          if (target = resolve_variant(value))
            return OursprivacyIngest::Internal::Type::Converter.coerce(target, value, state: state)
          end
        ...
        def dump(value, state:)
          if (target = resolve_variant(value))
            return OursprivacyIngest::Internal::Type::Converter.dump(target, value, state: state)
          end

          known_variants.each do
            target = _2.call
            if target === value
              return OursprivacyIngest::Internal::Type::Converter.dump(
                target,
                value,
                state: state
              )
        ...
        def to_sorbet_type
          types = variants.map do
            OursprivacyIngest::Internal::Util::SorbetRuntimeSupport.to_sorbet_type(_1)
          end.uniq
          case types
          in []
            T.noreturn
        ...
        def inspect(depth: 0)
          ...
          members = variants.map { OursprivacyIngest::Internal::Type::Converter.inspect(_1, depth: depth.succ) }
