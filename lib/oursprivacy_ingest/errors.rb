  ...
  module Errors
    ...
    class APIStatusError < OursprivacyIngest::Errors::APIError
      ...
      def self.for(url:, status:, headers:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          OursprivacyIngest::Errors::BadRequestError.new(**kwargs)
        in 401
          OursprivacyIngest::Errors::AuthenticationError.new(**kwargs)
        in 403
          OursprivacyIngest::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          OursprivacyIngest::Errors::NotFoundError.new(**kwargs)
        in 409
          OursprivacyIngest::Errors::ConflictError.new(**kwargs)
        in 422
          OursprivacyIngest::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          OursprivacyIngest::Errors::RateLimitError.new(**kwargs)
        in (500..)
          OursprivacyIngest::Errors::InternalServerError.new(**kwargs)
        else
          OursprivacyIngest::Errors::APIStatusError.new(**kwargs)
        end
      end
