...
echo -e "\033[32mInstallation: bundle remove oursprivacy-ingest && bundle add oursprivacy-ingest --source 'https://pkg.stainless.com/s/ours-privacy-ruby/$SHA'\033[0m"
