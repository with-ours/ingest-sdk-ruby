# Ours Privacy Ruby API library

The Ours Privacy Ruby library provides convenient access to the Ours Privacy REST API from any Ruby 3.2.0+ application. It ships with comprehensive types & docstrings in Yard, RBS, and RBI – [see below](https://github.com/stainless-sdks/ours-privacy-ruby#Sorbet) for usage with Sorbet. The standard library's `net/http` is used as the HTTP transport, with connection pooling via the `connection_pool` gem.
...
ours_privacy.track.event(token: "REPLACE_ME", event: "REPLACE_ME", request_options: {max_retries: 5})
```
...
See [the contributing documentation](https://github.com/stainless-sdks/ours-privacy-ruby/tree/main/CONTRIBUTING.md).
