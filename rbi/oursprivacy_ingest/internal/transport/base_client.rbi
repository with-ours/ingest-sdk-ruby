      ...
      class BaseClient
          ...
          T.type_alias do
            {
              ...
              page:
                T.nilable(
                  T::Class[
                    OursprivacyIngest::Internal::Type::BasePage[
              ...
              model:
                T.nilable(OursprivacyIngest::Internal::Type::Converter::Input),
        ...
        class << self
          ...
          sig do
            params(
              request:
                OursprivacyIngest::Internal::Transport::BaseClient::RequestInput,
              status: Integer,
          ...
          sig do
            params(
              status:
                T.any(Integer, OursprivacyIngest::Errors::APIConnectionError),
        ...
        # @api private
        sig do
          returns(OursprivacyIngest::Internal::Transport::PooledNetRequester)
        end
        ...
        sig do
          overridable
            .params(
              req:
                OursprivacyIngest::Internal::Transport::BaseClient::RequestComponents,
              opts: OursprivacyIngest::Internal::AnyHash
            )
            .returns(
              OursprivacyIngest::Internal::Transport::BaseClient::RequestInput
            )
        ...
        def request(
          ...
          page: nil,
          stream: nil,
          model: OursprivacyIngest::Internal::Type::Unknown,
          options: {}
        )
        end
