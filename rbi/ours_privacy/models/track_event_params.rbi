...
module OursPrivacy
  module Models
    class TrackEventParams < OursPrivacy::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(OursPrivacy::TrackEventParams, OursPrivacy::Internal::AnyHash)
        end
      ...
      # destinations
      sig do
        returns(T.nilable(OursPrivacy::TrackEventParams::DefaultProperties))
      end
      ...
      sig { returns(T.nilable(OursPrivacy::TrackEventParams::UserProperties)) }
        ...
        override.returns(
          {
            ...
            event: String,
            default_properties:
              T.nilable(OursPrivacy::TrackEventParams::DefaultProperties),
            distinct_id: T.nilable(String),
            email: T.nilable(String),
            event_properties: T.nilable(T::Hash[Symbol, T.nilable(T.anything)]),
            external_id: T.nilable(String),
            ...
            user_id: T.nilable(String),
            user_properties:
              T.nilable(OursPrivacy::TrackEventParams::UserProperties),
