  ...
  module Models
    class VisitorUpsertParams < OursPrivacy::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            OursPrivacy::VisitorUpsertParams,
      ...
      # them.
      sig { returns(OursPrivacy::VisitorUpsertParams::UserProperties) }
      attr_reader :user_properties

      sig do
        params(
          user_properties:
            OursPrivacy::VisitorUpsertParams::UserProperties::OrHash
        ).void
      end
      ...
      # destinations
      sig do
        returns(T.nilable(OursPrivacy::VisitorUpsertParams::DefaultProperties))
      end
      ...
      sig do
        params(
          default_properties:
            T.nilable(
              OursPrivacy::VisitorUpsertParams::DefaultProperties::OrHash
            )
        ).void
      end
      ...
      sig do
        override.returns(
          {
            token: String,
            user_properties: OursPrivacy::VisitorUpsertParams::UserProperties,
            default_properties:
              T.nilable(OursPrivacy::VisitorUpsertParams::DefaultProperties),
            email: T.nilable(String),
            external_id: T.nilable(String),
            user_id: T.nilable(String),
            request_options: OursPrivacy::RequestOptions
          }
        )
      end
      def to_hash
