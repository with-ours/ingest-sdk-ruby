  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(OursPrivacy::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              OursPrivacy::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: OursPrivacy::Internal::Type::Converter::Input,
              value: T.anything,
              state: OursPrivacy::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
