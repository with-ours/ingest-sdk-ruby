...
class OursPrivacy::Test::SingletonClient < OursPrivacy::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: OursPrivacy::Test::SingletonClient::TEST_API_BASE_URL)
  end
end
...
class OursPrivacy::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @ours_privacy = OursPrivacy::Test::SingletonClient.instance
  end
