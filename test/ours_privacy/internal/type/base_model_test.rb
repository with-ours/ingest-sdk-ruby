...
class OursPrivacy::Test::PrimitiveModelTest < Minitest::Test
  A = OursPrivacy::Internal::Type::ArrayOf[-> { Integer }]
  H = OursPrivacy::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend OursPrivacy::Internal::Type::Union
  end

  class B < OursPrivacy::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      OursPrivacy::Internal::Type::Unknown,
      OursPrivacy::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => OursPrivacy::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [OursPrivacy::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [OursPrivacy::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [OursPrivacy::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = OursPrivacy::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        OursPrivacy::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [OursPrivacy::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [OursPrivacy::Internal::Type::Boolean, true] => true,
      [OursPrivacy::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => OursPrivacy::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        OursPrivacy::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = OursPrivacy::Internal::Type::Converter.new_coerce_state
      OursPrivacy::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        OursPrivacy::Internal::Type::Converter.dump(target, input, state: state)
...
class OursPrivacy::Test::EnumModelTest < Minitest::Test
  class E0
    include OursPrivacy::Internal::Type::Enum
...
class OursPrivacy::Test::CollectionModelTest < Minitest::Test
  A1 = OursPrivacy::Internal::Type::ArrayOf[-> { Integer }]
  H1 = OursPrivacy::Internal::Type::HashOf[Integer]

  A2 = OursPrivacy::Internal::Type::ArrayOf[H1]
  H2 = OursPrivacy::Internal::Type::HashOf[-> { A1 }]

  A3 = OursPrivacy::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = OursPrivacy::Internal::Type::HashOf[Integer, nil?: true]
...
class OursPrivacy::Test::BaseModelTest < Minitest::Test
  class M1 < OursPrivacy::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < OursPrivacy::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < OursPrivacy::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, OursPrivacy::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = OursPrivacy::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = OursPrivacy::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(OursPrivacy::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue OursPrivacy::Errors::ConversionError => e
...
class OursPrivacy::Test::UnionTest < Minitest::Test
  class U0
    include OursPrivacy::Internal::Type::Union
  ...
  class M2 < OursPrivacy::Internal::Type::BaseModel
  ...
  class M4 < OursPrivacy::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, OursPrivacy::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < OursPrivacy::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, OursPrivacy::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class OursPrivacy::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include OursPrivacy::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [OursPrivacy::Internal::Type::Unknown, OursPrivacy::Internal::Type::Unknown] => true,
      [OursPrivacy::Internal::Type::Boolean, OursPrivacy::Internal::Type::Boolean] => true,
      [OursPrivacy::Internal::Type::Unknown, OursPrivacy::Internal::Type::Boolean] => false,
...
class OursPrivacy::Test::MetaInfoTest < Minitest::Test
  A1 = OursPrivacy::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = OursPrivacy::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
