...
class OursPrivacyTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    ...
    ours_privacy = OursPrivacy::Client.new(base_url: "http://localhost")

    assert_raises(OursPrivacy::Errors::InternalServerError) do
  ...
  def test_client_given_request_default_retry_attempts
    ...
    ours_privacy = OursPrivacy::Client.new(base_url: "http://localhost", max_retries: 3)
  ...
  def test_client_retry_after_seconds
    ...
    ours_privacy = OursPrivacy::Client.new(base_url: "http://localhost", max_retries: 1)
  ...
  def test_client_redirect_307
    ...
    assert_raises(OursPrivacy::Errors::APIConnectionError) do
    ...
    assert_requested(:any, "http://localhost/redirected", times: OursPrivacy::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: OursPrivacy::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: OursPrivacy::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
