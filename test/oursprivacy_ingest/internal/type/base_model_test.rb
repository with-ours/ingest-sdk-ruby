...
class OursprivacyIngest::Test::PrimitiveModelTest < Minitest::Test
  A = OursprivacyIngest::Internal::Type::ArrayOf[-> { Integer }]
  H = OursprivacyIngest::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < OursprivacyIngest::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      OursprivacyIngest::Internal::Type::Unknown,
      OursprivacyIngest::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => OursprivacyIngest::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [OursprivacyIngest::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [OursprivacyIngest::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [OursprivacyIngest::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        OursprivacyIngest::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      ...
      [OursprivacyIngest::Internal::Type::Boolean, true] => true,
      [OursprivacyIngest::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => OursprivacyIngest::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        OursprivacyIngest::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        OursprivacyIngest::Internal::Type::Converter.dump(target, input, state: state)
...
class OursprivacyIngest::Test::EnumModelTest < Minitest::Test
  class E0
    include OursprivacyIngest::Internal::Type::Enum
...
class OursprivacyIngest::Test::CollectionModelTest < Minitest::Test
  ...
  A2 = OursprivacyIngest::Internal::Type::ArrayOf[H1]
  H2 = OursprivacyIngest::Internal::Type::HashOf[-> { A1 }]

  A3 = OursprivacyIngest::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = OursprivacyIngest::Internal::Type::HashOf[Integer, nil?: true]
...
class OursprivacyIngest::Test::BaseModelTest < Minitest::Test
  class M1 < OursprivacyIngest::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < OursprivacyIngest::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < OursprivacyIngest::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, OursprivacyIngest::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = OursprivacyIngest::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = OursprivacyIngest::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(OursprivacyIngest::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue OursprivacyIngest::Errors::ConversionError => e
...
class OursprivacyIngest::Test::UnionTest < Minitest::Test
  ...
  class M2 < OursprivacyIngest::Internal::Type::BaseModel
  ...
  class M4 < OursprivacyIngest::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, OursprivacyIngest::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < OursprivacyIngest::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, OursprivacyIngest::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class OursprivacyIngest::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include OursprivacyIngest::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [OursprivacyIngest::Internal::Type::Unknown, OursprivacyIngest::Internal::Type::Unknown] => true,
      [OursprivacyIngest::Internal::Type::Boolean, OursprivacyIngest::Internal::Type::Boolean] => true,
      [OursprivacyIngest::Internal::Type::Unknown, OursprivacyIngest::Internal::Type::Boolean] => false,
...
class OursprivacyIngest::Test::MetaInfoTest < Minitest::Test
  A1 = OursprivacyIngest::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = OursprivacyIngest::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
