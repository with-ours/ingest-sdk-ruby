...
```ruby
gem "ours-privacy", git: "https://www.github.com/stainless-sdks/ours-privacy-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/stainless-sdks/ours-privacy-ruby' '<path-to-repo>'
```
